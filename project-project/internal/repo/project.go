...
type ProjectRepo interface {
	...
	FindProjectById(ctx context.Context, projectCode int64) (pj *mproject.Project, err error)
	FindProjectByIds(ctx context.Context, pids []int64) (list []*mproject.Project, err error)
}
