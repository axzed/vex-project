...
func (c *CacheInterceptor) CacheInterceptor(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (resp interface{}, err error) {
	// grpc.UnaryInterceptor 为grpc的UnaryInterceptor类型 (grpc.UnaryInterceptor是一个函数类型)
